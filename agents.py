...
#        )
    ...
    def researcher(self):
        ...
        return Agent(
            ...
            goal='Find current news stories',
            backstory='You search the internet for recent stories. You make sure our readers are always in the know',            
            verbose=True,
            allow_delegation=True,
            tools=[self.web],
            llm=self.gpt3,
